...
השעשועון מיועד להרצה ישירות מתוך הדפדפן ללא צורך בהתקנה מקומית כלשהי:
1. פותחים את הקישור לשעשועון בדפדפן במחשב (המחובר לטלוויזיה או למקרן).
2. יוצרים חדר חדש עם מספר מותאם אישית (למשל `4`).
3. פותחים את אותו הקישור בטלפון הנייד, בוחרים בלשונית **התחבר לחדר קיים** ומתחברים כשלט מנחה עם אותו מספר חדר.
4. מעדכנים את פרטי המשפחה והשאלות ישירות משלט המנחה בטלפון, ולוחצים על **פתח מסך הקרנה 📺** במחשב כדי להתחיל לשחק!
